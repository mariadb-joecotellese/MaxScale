...
if(DISTRIB_SUFFIX)
  set(VERSION_SUFFIX "${MAXSCALE_VERSION}.${MAXSCALE_ENTERPRISE_VERSION_PATCH}-${MAXSCALE_BUILD_NUMBER}.${DISTRIB_SUFFIX}.${CMAKE_SYSTEM_PROCESSOR}.rpm")
  set(CPACK_RPM_PACKAGE_RELEASE "${MAXSCALE_BUILD_NUMBER}.${DISTRIB_SUFFIX}")
else()
  set(VERSION_SUFFIX "${MAXSCALE_VERSION}.${MAXSCALE_ENTERPRISE_VERSION_PATCH}-${MAXSCALE_BUILD_NUMBER}.${CMAKE_SYSTEM_PROCESSOR}.rpm")
