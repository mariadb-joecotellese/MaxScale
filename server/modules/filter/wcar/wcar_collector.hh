...
/*  IMPORTANT!!!!!!!!!!
 *  This is a copy of collector.hh from p_24.02 into p_24.02.1 for use in
 *  wcar until version p_24.02.2 is created. Once that happens this file
 *  can be deleted and the actual maxbase/collector.hh #included instead.
 */
